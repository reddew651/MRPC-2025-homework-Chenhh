                      ...
                      Quadrotor::InternalState& dxdt, const double /* t */)
{
  ...
  x_dot = cur_state.v;
  Eigen::Vector3d gravity_acc(0.0, 0.0, -g_);
  Eigen::Vector3d thrust_force = R.col(2) * thrust;
  Eigen::Vector3d drag_force = -resistance * vnorm;
  Eigen::Vector3d total_force = mass_ * gravity_acc + thrust_force + external_force_ + drag_force;
  ...
  Eigen::Vector3d total_moment = moments + external_moment_ - coriolis;
  omega_dot = J_.inverse() * total_moment;
